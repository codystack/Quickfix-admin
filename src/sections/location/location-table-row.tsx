...
import UpdateLocation from './view/update-location';
...
export function LocationTableRow({ row, selected, onSelectRow }: LocationTableRowProps) {
  ...
  const deleteLocation = () => {
    const prom = APIService.deleteLocation(row?._id ?? row?.id);
  ...
  return (
    <>
      <CustomizedDialog
        ...
        body={
          <UpdateLocation setOpen={setOpenEdit} locationData={row} />
        }
      />
      ...
      <CustomizedDialog
        ...
        title={title}
        body={
          <RenderConfirmation setOpen={setOpen} message={message} action={() => deleteLocation()} />
        }
      />
            ...
            <>
              ...
              <MenuItem
                onClick={() => {
                  ...
                  setMessage(
                    `Are you sure you want to delete this location? Action is irreversible.`
                  );
                  handleClosePopover();
                  setOpen(true);
                }}
