...
var Zoom = React7.forwardRef(function Zoom2(props, ref) {
...
var SpeedDial = React9.forwardRef(function SpeedDial2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSpeedDial"
  });
  ...
  const {
    ...
    TransitionProps
  } = props, FabProps = _objectWithoutPropertiesLoose(props.FabProps, _excluded7), other = _objectWithoutPropertiesLoose(props, _excluded23);
  ...
  const focusedAction = React9.useRef(0);
  const nextItemArrowKey = React9.useRef();
  const actions = React9.useRef([]);
  actions.current = [actions.current[0]];
  const handleOwnFabRef = React9.useCallback((fabFef) => {
  ...
  const allItems = React9.Children.toArray(childrenProp).filter((child) => {
    if (true) {
  ...
  return (0, import_jsx_runtime12.jsxs)(SpeedDialRoot, _extends({
    className: clsx_default(classes.root, className),
    ref,
    role: "presentation",
    ...
    children: [(0, import_jsx_runtime11.jsx)(TransitionComponent, _extends({
      ...
      children: (0, import_jsx_runtime11.jsx)(SpeedDialFab, _extends({
        color: "primary",
        ...
        ref: handleFabRef,
        ownerState,
        children: React9.isValidElement(icon) && isMuiElement_default(icon, ["SpeedDialIcon"]) ? React9.cloneElement(icon, {
          open
        }) : icon
      }))
    })), (0, import_jsx_runtime11.jsx)(SpeedDialActions, {
      id: `${id}-actions`,
      role: "menu",
...
var _excluded8 = ["className", "delay", "FabProps", "icon", "id", "open", "TooltipClasses", "tooltipOpen", "tooltipPlacement", "tooltipTitle"];
...
var SpeedDialAction = React10.forwardRef(function SpeedDialAction2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSpeedDialAction"
  });
  ...
  const [tooltipOpen, setTooltipOpen] = React10.useState(tooltipOpenProp);
  ...
  const fab = (0, import_jsx_runtime13.jsx)(SpeedDialActionFab, _extends({
    size: "small",
  ...
  if (tooltipOpenProp) {
    return (0, import_jsx_runtime14.jsxs)(SpeedDialActionStaticTooltip, _extends({
      id,
      ref,
      className: classes.staticTooltip,
      ownerState
    }, other, {
      children: [(0, import_jsx_runtime13.jsx)(SpeedDialActionStaticTooltipLabel, {
        style: transitionStyle,
        id: `${id}-label`,
        className: classes.staticTooltipLabel,
        ownerState,
        children: tooltipTitle
      }), React10.cloneElement(fab, {
  ...
  return (0, import_jsx_runtime13.jsx)(Tooltip_default, _extends({
    id,
    ref,
    title: tooltipTitle,
...
var Add_default = createSvgIcon((0, import_jsx_runtime15.jsx)("path", {
...
var _excluded9 = ["className", "icon", "open", "openIcon"];
...
var SpeedDialIcon = React12.forwardRef(function SpeedDialIcon2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiSpeedDialIcon"
  });
  ...
  return (0, import_jsx_runtime17.jsxs)(SpeedDialIconRoot, _extends({
    className: clsx_default(classes.root, className),
    ref,
    ownerState
  }, other, {
    children: [openIconProp ? formatIcon(openIconProp, classes.openIcon) : null, iconProp ? formatIcon(iconProp, classes.icon) : (0, import_jsx_runtime16.jsx)(Add_default, {
...
var TabScrollButton = React13.forwardRef(function TabScrollButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime18.jsx)(TabScrollButtonRoot, _extends({
    component: "div",
    className: clsx_default(classes.root, className),
    ref,
    role: null,
    ...
    children: direction === "left" ? (0, import_jsx_runtime18.jsx)(StartButtonIcon, _extends({}, startButtonIconProps)) : (0, import_jsx_runtime18.jsx)(EndButtonIcon, _extends({}, endButtonIconProps))
  }));
});
...
var Tabs = React15.forwardRef(function Tabs2(inProps, ref) {
  ...
  const getConditionalElements = () => {
    ...
    conditionalElements2.scrollbarSizeListener = scrollable ? (0, import_jsx_runtime20.jsx)(TabsScrollbarSize, {
      onChange: handleScrollbarSizeChange,
      className: clsx_default(classes.scrollableX, classes.hideScrollbar)
    }) : null;
    const scrollButtonsActive = displayStartScroll || displayEndScroll;
    const showScrollButtons = scrollable && (scrollButtons === "auto" && scrollButtonsActive || scrollButtons === true);
    conditionalElements2.scrollButtonStart = showScrollButtons ? (0, import_jsx_runtime20.jsx)(ScrollButtonComponent, _extends({
      slots: {
    ...
    conditionalElements2.scrollButtonEnd = showScrollButtons ? (0, import_jsx_runtime20.jsx)(ScrollButtonComponent, _extends({
      slots: {
  ...
  const indicator = (0, import_jsx_runtime20.jsx)(TabsIndicator, _extends({}, TabIndicatorProps, {
  ...
  return (0, import_jsx_runtime21.jsxs)(TabsRoot, _extends({
    className: clsx_default(classes.root, className),
    ownerState,
    ref,
    as: component
  }, other, {
    children: [conditionalElements.scrollButtonStart, conditionalElements.scrollbarSizeListener, (0, import_jsx_runtime21.jsxs)(TabsScroller, {
      ...
      ref: tabsRef,
      children: [(0, import_jsx_runtime20.jsx)(FlexContainer, {
        "aria-label": ariaLabel,
        "aria-labelledby": ariaLabelledBy,
...
var ToggleButtonGroupContext = React16.createContext({});
if (true) {
...
var ToggleButtonGroupButtonContext = React17.createContext(void 0);
if (true) {
...
var ToggleButton = React18.forwardRef(function ToggleButton2(inProps, ref) {
  const _React$useContext = React18.useContext(ToggleButtonGroupContext_default), {
    value: contextValue
  } = _React$useContext, contextProps = _objectWithoutPropertiesLoose(_React$useContext, _excluded13);
  const toggleButtonGroupButtonContextPositionClassName = React18.useContext(ToggleButtonGroupButtonContext_default);
  ...
  return (0, import_jsx_runtime22.jsx)(ToggleButtonRoot, _extends({
...
var ToggleButtonGroup = React19.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiToggleButtonGroup"
  });
  ...
  const handleChange = React19.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  const handleExclusiveChange = React19.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  return (0, import_jsx_runtime23.jsx)(ToggleButtonGroupRoot, _extends({
    role: "group",
    className: clsx_default(classes.root, className),
    ref,
    ownerState
...
//# sourceMappingURL=chunk-FG5VWQ6Y.js.map
